...
function generateReplyPrompt(comment) {
    ...
    Write a single thoughtful, concise, and relevant reply to this comment. Keep it brief and natural. Do not provide multiple options or explanations.`
}
...
const blogSummaryPrompt = (blogContent) => (`
    ...
    - Under the heading, list 3-5 key takeaways or skills the reader will learn in **bullet points** using markdown (\`-\`).
