      ...
      <span className="grid md:grid-cols-3 gap-10 md:gap-5">
        {data.slice(0, 6).map((course) => (
          <section
            ...
            key={course.course}
            className="bg-white grid md:grid-rows-[3fr_1fr] max-w-[1200px] border border-slate-200 rounded hover:cursor:pointer hover:scale-105 active:scale-95 hover:cursor-pointer duration-200"
          >
            <img src={course.image} alt="" className="object-cover rounded-t" />
