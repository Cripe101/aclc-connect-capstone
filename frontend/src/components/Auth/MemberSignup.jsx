...
const MemberSignup = ({ setCurrentPage }) => {
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            ...
            const response = await axiosInstance.post(API_PATHS.AUTH.REGISTER, {
                ...
                password,
                profileImageUrl,
                // No admin token for member signup
            })

            // On successful signup, update user context and close auth form
        ...
        <div className='w-full max-w-7xl mx-auto flex flex-col md:flex-row items-stretch rounded-3xl overflow-hidden bg-white'>
            ...
            <div className='w-full md:w-1/2 flex flex-col justify-center p-8 md:p-12 lg:p-16 max-h-screen md:overflow-y-auto'>
                ...
                <div className='mb-10'>
                    ...
                    <h1 className='text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3'>Join Us</h1>
                    <p className='text-gray-600 text-base md:text-lg'>Create your account and start exploring</p>
                </div>
            ...
            <div className='hidden md:flex w-1/2 bg-linear-to-br from-green-500 to-teal-600 items-center justify-center relative overflow-hidden p-8'>
                {/* Decorative Elements */}
                ...
                <div className='relative z-10 text-white text-center max-w-md'>
                    <div className='mb-8'>
                        <h2 className='text-4xl lg:text-5xl font-bold mb-4'>Welcome!</h2>
                    ...
                    <div className='space-y-4 text-sm lg:text-base text-green-50'>
