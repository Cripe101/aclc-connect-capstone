  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      <div className="mb-20">
        ...
        <article className="max-w-4xl mx-auto text-justify text-gray-700 leading-relaxed space-y-6">
      ...
      <div className="mb-20">
        ...
        <article className=" text-justify max-w-4xl mx-auto text-gray-700 leading-relaxed space-y-6">
